...
const listElements =
  todoList === null || todoList === void 0
    ? void 0
    : todoList.getElementsByClassName("list-element");
...
const assignListEvents = function (el) {
  var _a, _b;
  (_a = el.querySelector(".checkbox")) === null || _a === void 0
    ? void 0
    : _a.addEventListener("click", function () {
        var _a;
        (_a = this.closest("label")) === null || _a === void 0
          ? void 0
          : _a.classList.toggle("checked");
      });
  (_b = el.querySelector(".delete-btn")) === null || _b === void 0
    ? void 0
    : _b.addEventListener("click", function () {
        var _a;
        (_a = this.closest(".list-element")) === null || _a === void 0
          ? void 0
          : _a.remove();
        updateListNumber();
      });
};
clearCompleted === null || clearCompleted === void 0
  ? void 0
  : clearCompleted.addEventListener("click", function () {
      ...
      els.forEach((el) => {
        var _a;
        if (
          (_a = el.querySelector("label")) === null || _a === void 0
            ? void 0
            : _a.classList.contains("checked")
        ) {
          el.remove();
        }
      });
...
switchThemeBtn === null || switchThemeBtn === void 0
  ? void 0
  : switchThemeBtn.addEventListener("click", () => {
      document.documentElement.classList.toggle("tw-dark");
    });
newTodoElement === null || newTodoElement === void 0
  ? void 0
